...
export default function CodeCard() {
  return (
    <div
      ...
      aria-hidden="true"
    >
      <div className="inverse-toggle h-[300px] overflow-hidden rounded-lg border border-ss-purple-200/20 bg-white/10 px-1 pb-6 pt-4 font-mono text-[10px] leading-normal text-ss-purple-50 subpixel-antialiased shadow-lg transition-all sm:h-[400px] sm:px-2 sm:text-xs md:px-5">
