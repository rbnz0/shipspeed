    ...
    <>
      <button
        ...
        className={clsx(
          ...
          {
            "hover:bg-t3-purple/20 border border-ss-purple-200/20 bg-ss-purple-200/10 duration-300 hover:border-ss-purple-200/50":
              isLanding,
            "dark:hover:bg-t3-purple/20 border bg-ss-purple-200/50 duration-300 hover:bg-ss-purple-200/75 dark:border-ss-purple-200/20 dark:bg-ss-purple-200/10 dark:text-slate-100 dark:hover:border-ss-purple-200/50":
              !isLanding,
          },
        )}
      >
