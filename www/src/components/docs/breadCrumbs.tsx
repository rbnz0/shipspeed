...
export default function BreadCrumbs() {
  ...
  return (
    <div className="flex items-center gap-2 px-4 text-sm">
      <a
        href="/"
        className="rounded-lg border bg-ss-purple-200/50 p-1 hover:bg-ss-purple-200/75 hover:no-underline dark:border-ss-purple-200/20 dark:bg-ss-purple-200/10 dark:hover:border-ss-purple-200/50"
      >
