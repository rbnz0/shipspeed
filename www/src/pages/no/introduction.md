---
title: Introduksjon
description: Introduksjon til ShipSpeed-stakken
...
_"ShipSpeed-stakken"_ er en webutviklingsstakk inspirert av [Theo](https://twitter.com/rbnog) som fokuserer på enkelhet, modularitet og full typesikkerhet.
...
Du har kanskje lagt merke til at ShipSpeed-stakken har mange komponenter. Det er med vilje. Bytt ut delene hvis du trenger dem - stakken er modulær i kjernen :)

## Så... hva er create-shipspeed? En mal?

På en måte? `create-shipspeed` er en CLI utviklet av erfarne ShipSpeed-stakk-utviklere som forenkler oppsett av en modulær ShipSpeed-stakk-app. Dette betyr at hver komponent er valgfri og "malen" lages basert på dine spesifikke krav.
