---
title: Installasjon
description: Installasjonsveiledning for ShipSpeed
...
For å lage en app med `create-shipspeed`, kjør en av følgende tre kommandoer og svar på spørsmålene i veiviseren:
...
| `-y`, `--default` | CLI vil bli hoppet over og en ny ShipSpeed vil bli opprettet med alle alternativene valgt |
...
Følgende vil lage en ShipSpeed med både tRPC og Tailwind CSS.
