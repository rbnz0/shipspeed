---
title: الخطوات الاول
description: الخطوات الاولي في create-shipspeed
layout: ../../../layouts/docs.astro
lang: ar
dir: rtl
---

لقد أنشأت للتو مَشروعا باستخدام ShipSpeed Stack ، هذة هي الخُطوات الاجبارية التي يجب إتباعها قبل أن تتمكن من تشغيل المشروع.
