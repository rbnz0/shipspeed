---
title: لماذا ShipSpeed؟
description: لماذا يجب عليك اختيار ShipSpeed لتطبيقك المقبل
layout: ../../layouts/docs.astro
lang: ar
dir: rtl
---

لقد أنشئنا ShipSpeed لان [Theo](https://twitter.com/rbnog) رفض أن يصنع قالب محضَر لتِقنيته المُفضلة. ألهمنا حُبنا لـ typesafety، جَنباََ إلى جَنب مع create-next-app، و [Astro's CLI](https://astro.build)، للعمل عَلى قَدم وساق لصُنع أفضل نُقطة بِداية مُمكنة لمشاريع ShipSpeed.
...
بينما نؤمن بالحفاظ عَلى بَساطة الأشياء قَدرَ الإمكان، فإن هُناك أجزاء بَرمجيةَّ صَغيرة تَتكرر في كُل "تَطبيق" مثل المشروعات التي ننشئها، `create-shipspeed` تَسمح لك بتبني الجزء بصورةِِ رائعة.
