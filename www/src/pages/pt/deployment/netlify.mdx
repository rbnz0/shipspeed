...
Netlify é um provedor de deploy alternativo semelhante à Vercel. Veja [`ajcwebdev/shipspeed-netlify`](https://github.com/ajcwebdev/shipspeed-netlify) para um exemplo de repositório baseado nesta documentação.
...
Para ver um exemplo rodando na Netlify, visite [shipspeed.netlify.app](https://shipspeed.netlify.app/).
