...
要使用 `create-shipspeed` 创建一个应用程序，请运行以下任意一个命令，并回答命令提示符的问题：
...
| `-y`, `--default` | 跳过 CLI 并选中所有选项来初始化新的 ShipSpeed |
...
下面的命令将使用 tRPC 和 Tailwind CSS 创建一个 ShipSpeed。
