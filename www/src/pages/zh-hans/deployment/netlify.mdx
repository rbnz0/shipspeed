...
Netlify 是与 Vercel 类似的托管平台服务商。参看基于本文档的示例仓库 [`ajcwebdev/shipspeed-netlify`](https://github.com/ajcwebdev/shipspeed-netlify)。
...
访问 [shipspeed.netlify.app](https://shipspeed.netlify.app/) 来查看运行在 Netlify 上的示例项目。
