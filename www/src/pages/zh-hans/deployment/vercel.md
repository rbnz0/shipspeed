...
我们推荐将你的应用部署到 [Vercel](https://vercel.com/?utm_source=rbnog&utm_campaign=oss)。它大大简化了 Next.js 应用的部署流程。
...
1. 当你将代码成功 push 到 GitHub 仓库后，使用 GitHub 注册 [Vercel](https://vercel.com/?utm_source=rbnog&utm_campaign=oss)，然后点击**添加新项目**。
