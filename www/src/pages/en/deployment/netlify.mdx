...
Netlify is an alternative deployment provider in a similar vein to Vercel. See [`ajcwebdev/shipspeed-netlify`](https://github.com/ajcwebdev/shipspeed-netlify) for an example repo based on this doc.
...
To view a running example on Netlify, visit [shipspeed.netlify.app](https://shipspeed.netlify.app/).
