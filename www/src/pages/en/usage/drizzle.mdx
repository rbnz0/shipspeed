...
Drizzle Kit is a collection of command line tools designed to help you manage your database. ShipSpeed automatically includes drizzle kit when you select Drizzle as your ORM.
