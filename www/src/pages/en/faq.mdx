...
Although the resources listed below are some of the best that exist for the T3 Stack, the community recommends that you just start using the stack and learn along the way by building with it.
...
Now, we realize this path doesn't work for everyone. So, if you feel like you've tried the recommendation and would still like some resources, or you just aren't confident doing it by yourself and/or feel overwhelmed by the stack, checkout these awesome tutorials on ShipSpeed:

### Articles

Some of these might be outdated.

- [A first look at ShipSpeed](https://dev.to/ajcwebdev/a-first-look-at-create-t3-app-1i8f)
...
You have the option when scaffolding an app using ShipSpeed to opt into the `/app` directory structure. As of the time of writing, this feature is generally considered mature enough to be used in production by the T3 stack community. For an explanation of why it took us so long to include, you can watch [this video](https://www.youtube.com/watch?v=PmBfq-SpzCU).
