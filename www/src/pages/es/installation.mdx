---
title: Instalación
description: Instrucciones de instalación para ShipSpeed
...
Para crear una aplicación usando `create-shipspeed`, ejecuta cualquiera de los siguientes tres comandos y responde las preguntas en la línea de comandos:
...
| `-y`, `--default` | Omite la CLI y arranca una nueva aplicación ShipSpeed con todas las opciones seleccionadas       |
...
Lo siguiente sería una aplicación ShipSpeed con tRPC y Tailwind CSS.
