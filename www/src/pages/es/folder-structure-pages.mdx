...
description: Estructura de carpetas de una aplicación ShipSpeed recién creada
...
Por favor selecciona las librerías que deseas utilizar para ver la estructura de carpetas de una aplicación ShipSpeed recién creada con esas selecciones. Más abajo, encontrarás una descripción de cada entrada.
...
El archivo `tscconfig.json` se usa para configurar TypeScript. Algunos no predeterminados, como `modo estricto`, se han habilitado para garantizar el mejor uso de TypeScript para ShipSpeed y sus bibliotecas. Consulta [la documentación de TypeScript](https://www.typescriptlang.org/docs/handbook/tsconfig-json.html) o [uso de TypeScript](usage/typescript) para obtener más información.
