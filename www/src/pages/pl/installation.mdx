---
title: Instalacja
description: Instrukcje instalacji dla ShipSpeed.
...
Aby zacząć używać szablonu `create-shipspeed`, uruchom którąkolwiek z poniższych trzech komend i odpowiedz na pytania w konsoli:
...
Poniższy przykład stworzy aplikację ShipSpeed z bibliotekami tRPC oraz Tailwind CSS.
