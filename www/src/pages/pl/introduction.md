---
title: Wstęp
description: Wstęp do stack ShipSpeed
...
_"ShipSpeed Stack"_, to stack do web developmentu stworzony przez [Theo](https://twitter.com/rbnog) i mający na celu prostotę, modularność oraz typesafety całego projektu.
...
## A więc... co to ShipSpeed? Jakiś szablon?

Może? ShipSpeed to narzędzie CLI zbudowane przez doświadczonych deweloperów stack ShipSpeed aby usprawnić zakładanie w nim nowych, modularnych projektów. Oznacza to, iż każdy element jest opcjonalny a "szablon" generowany jest bazując na twoich szczegółowych potrzebach.
