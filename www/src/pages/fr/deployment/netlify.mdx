...
Netlify est un fournisseur de déploiement alternatif dans la même veine que Vercel. Voir [`ajcwebdev/shipspeed-netlify`](https://github.com/ajcwebdev/shipspeed-netlify) pour un exemple de dépôt basé sur ce document.
...
Pour afficher un exemple d'exécution sur Netlify, visitez [shipspeed.netlify.app](https://shipspeed.netlify.app/).
