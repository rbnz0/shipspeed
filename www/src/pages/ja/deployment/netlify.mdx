...
Netlify は Vercel の代替となり得る同系統のデプロイメントプロバイダです。本ドキュメントに基づいたサンプルリポジトリは [`ajcwebdev/shipspeed-netlify`](https://github.com/ajcwebdev/shipspeed-netlify) を参照してください。
...
Netlify での実行例は、[shipspeed.netlify.app](https://shipspeed.netlify.app/)でご覧ください。
