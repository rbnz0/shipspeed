---
title: フォルダ構造 (Pages)
description: 初期構成として新規に生成されたShipSpeedのフォルダ構造
...
`tsconfig.json`ファイルは、TypeScript を設定するために使用されます。ShipSpeed とそのライブラリの TypeScript を最適に利用するために、`strict mode`のようないくつかの非デフォルトが有効になっています。詳細については、[TypeScript ドキュメント](https://www.typescriptlang.org/docs/handbook/tsconfig-json.html) または [使用法の TypeScript](usage/typescript) を参照してください。
