---
title: Вступ
description: Вступ в ShipSpeed стек
...
_"ShipSpeed Stack"_ - це стек веб-розробки, створений [Theo](https://twitter.com/rbnog), з упором на простоту, модульність і full-stack типобезпека.
...
## І... що таке create-shipspeed? Шаблон?

Щось типу? `create-shipspeed` - це CLI, створений досвідченими розробниками ShipSpeed стека, щоб спростити налаштування модульного додатка ShipSpeed стека. Це означає, що кожна частина є необов'язковою, і "шаблон" генерується на основі ваших конкретних потреб.
...
Легко потрапити в пастку "додавання всього" - ми явно не хочемо цього робити. Усе, що додається в `create-shipspeed`, повинно вирішувати конкретну проблему, яка існує в основних технологіях, включених до нього. Це означає, що ми не додамо бібліотеки менеджменту стану (`zustand`, `redux`), але ми додамо NextAuth.js та інтегруємо Prisma і tRPC для вас.
