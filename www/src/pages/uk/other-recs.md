...
Ми розуміємо, що бібліотеки, включені до `create-shipspeed`, не вирішують кожну проблему. Хоча ми рекомендуємо розпочати свій проект з того, що ми надаємо, настане час, коли вам потрібно буде встановити інші пакети. Тільки ви можете знати, чого потребує ваш проект, але ось деякі рішення, які ми часто рекомендуємо.

Це рекомендації окремих учасників ShipSpeed і не повинні розглядатись як "офіційні" рекомендації команди ShipSpeed або rbnog. _**Будь ласка, проведіть власне дослідження, особливо перед тим, як прив'язуватись до платних сервісів**_.
...
- [Гайд із деплою ShipSpeed на Vercel](/uk/deployment/vercel)
...
Якщо WebSocket є основним фокусом вашого проекту, ви можете розглянути більш традиційний бекенд, такий як [Fastify](https://www.fastify.io/) (який [також працює з tRPC!](https://trpc.io/docs/v10/fastify)). Але для швидкого додавання WebSocket у ShipSpeed, Pusher - чудовий вибір.
