---
title: Первые шаги
description: Начало работы с вашим новым ShipSpeed
layout: ../../../layouts/docs.astro
lang: ru
---

Вы только что создали новое приложение ShipSpeed и готовы к работе. Вот минимальный набор для запуска вашего приложения.
...
- Посмотрите на документацию `create-shipspeed`, а также на документацию пакетов, которые включает ваше приложение.
- Присоединяйтесь к нашему [Discord](https://github.com/rbnog/shipspeed/discussions) и поставьте звезду на [GitHub](https://github.com/rbnog/shipspeed)! :)
